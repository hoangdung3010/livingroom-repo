...
<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
		  <a class="nav-link" href="" class="nav-link"> <i class="fas fa-home"></i> Trang chủ</a>
      </li>
		<li class="nav-item">
  ...
  <!-- /.navbar -->
<?php /**PATH C:\xampp\htdocs\doan101198\resources\views/admin/partials/header.blade.php ENDPATH**/ ?>