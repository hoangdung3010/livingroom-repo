...
@section('image', asset($seo->image_path))
@section('keywords', $seo->slug)
@section('description', $seo->value)
@section('abstract', $seo->slug)
                                    ...
                                    <div aria-live="polite" class="slick-list draggable">
                                        <div class="slick-track"
                                            ...
                                            <div class="item slick-slide slick-current slick-active" data-slick-index="0"
                                                ...
                                                <a href="{{ route('product.productByCategory',['slug'=>$item->slug]) }}" tabindex="0">
                                                    <div class="box">
                                                        <div class="image">
                                                        ...
                                                        <div class="box">
                                                            <div class="image">
                                                                <a
                                                                    ...
                                                                    <img src="{{ asset($item->product_img) }}" alt="{{ $item->name }}">
                                                                        @if ($item->sale)
                                                            ...
                                                            <div class="content">
                                                                ...
                                                                <div class="box-price">
                                                                    <span class="new-price">Giá: {{ $item->price_after_sale?number_format($item->price_after_sale)." ".$unit??'':"Liên hệ" }}</span>
                                                                    @if ($item->sale>0)
                                                                        <span class="old-price">{{ number_format($item->price) }} {{ $unit??''  }}</span>
                                                                    @endif
                                                                </div>
                                                                <div class="free">
                            ...
                            <div class="col-12 col-sm-12">
                                ...
                                <div class="list-post-home tin-tuc-home category-slide-1 category-slide-2">
                                    ...
                                    <div class="item-post">
                                        <div class="box">
                                         <div class="image">
                                             <a href="{{ route('post.detail',['slug'=>$post->slug]) }}"><img src="{{ asset($post->avatar_path) }}" alt="{{ $post->name }}"></a>
                                             <div class="info">
                                                 <span>{{ date_format($post->created_at,'d/m/Y') }}</span>
                                             </div>
                                         </div>
                                         <div class="content">
                                             <div class="name"><a href="{{ route('post.detail',['slug'=>$post->slug]) }}">{{ $post->name }}</a></div>
                                             <div class="desc">
                                                 {!! $post->description !!}
                                             </div>
                                             <div class="text-left">
                                                <a href="{{ route('post.detail',['slug'=>$post->slug]) }}" class="link-detail">Chi tiết <i class="fas fa-long-arrow-alt-right"></i></a>
                                             </div>
                                         </div>
                                        </div>
                                     </div>
