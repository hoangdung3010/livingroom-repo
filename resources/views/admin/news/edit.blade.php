                                            ...
                                            <div id="tong_quan" class="container tab-pane active"><br>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea class="form-control tinymce_editor_init @error('noidung') is-invalid  @enderror" name="noidung" id="" rows="20" placeholder="Nhập nội dung">
                                                            {{old('noidung')?? $data->noidung }}
                                                            </textarea>
                                                        </div>
                                                    </div>
                                                    @error('noidung')
                                            ...
                                            <div id="hinh_anh" class="container tab-pane fade"><br>
                                                <div class="wrap-load-image mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control-file img-load-input border"  id="" value="{{$data->avatar_path}}" name="avatar_path" >
                                                    </div>
                                                    @error('avatar_path')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
