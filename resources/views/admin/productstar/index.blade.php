                              ...
                              <table class="table table-head-fixed">
                                 ...
                                 <tbody>
                                     ...
                                     <tr>
                                         ...
                                         <td> <a href="{{ $productstar->product->slug_full ??''}}" target="_blank"> {{ $productstar->product->name ??''}} </a></td>
                                         <td class="wrap-load-hot" data-url="{{ route('admin.productstar.load.hot',['id'=>$productstar->id]) }}">
                                            @include('admin.components.load-change-sp_ngoc',['data'=>$productstar,'type'=>'đánh giá'])
                                         </td>
