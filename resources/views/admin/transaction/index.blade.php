                                  ...
                                  @endphp
                                    <div class="col-md-4 col-sm-6 col-12">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number"><strong></strong> {{ number_format($totalAmount) }}</span>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <ul>
                                                ...
                                                @if($transaction->cn)
                                                <li>
                                                    <div><strong>Tên ngân hàng:</strong>   {{ optional($transaction->setting('cn')->first())->value }}</div>
                                                    <div><strong>Thông tin tài khoản:</strong>   {{ optional($transaction->setting('cn')->first())->name }}</div>
                                                </li>
                                                @endif
                                             </ul>
                                         </td>
                                         ...
                                         <td>
                                            <a target="_blank" href="{{ route('admin.transaction.detail.export.pdf', ['id' => $transaction->id ]) }}" class="btn btn-sm btn-info taiphieu" rel="noopener noreferrer">Tải phiếu pdf</a>
